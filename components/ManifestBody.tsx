import styles from "@/styles/manifest-body.module.css";
  ...
  return (
    <section id="manifiesto" className={styles.section}>
      <div className={styles.header}>
        <span className={styles.eyebrow}>Manifiesto</span>
        <h2 className={styles.heading}>Comprender antes que controlar</h2>
      </div>
